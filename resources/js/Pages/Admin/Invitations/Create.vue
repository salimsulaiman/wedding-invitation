...
const availableThemes = computed<Theme[]>(() => {
    ...
    return props.themes.filter(theme =>
        selectedCustomer.value!.accessible_theme_category_ids.includes(
            theme.theme_category_id,
        ),
    )
})
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-0.5 text-sm text-slate-500">
                    Isi info dasar, sisanya bisa dilengkapi di builder.
                </p>
            </div>
        </div>
        ...
        >
            ...
            <div>
                ...
                <div
                    ...
                    class="mt-1.5 flex items-center gap-2 rounded-lg bg-slate-50 px-3.5 py-2.5 text-sm text-slate-400"
                >
                    Pilih customer terlebih dahulu.
                </div>

                <div
                    v-else-if="availableThemes.length === 0"
                    class="mt-1.5 flex items-start gap-2 rounded-lg bg-amber-50 px-3.5 py-2.5 text-sm text-amber-700"
                >
                    <AlertCircle class="mt-0.5 h-4 w-4 shrink-0" />

                    Customer ini belum memiliki akses ke paket tema manapun.
                    Buka akses paket dulu di halaman Edit Akun.
                </div>
                ...
                >
                    <option value="">
                        Belum pilih tema (bisa diatur di builder)
                    </option>
