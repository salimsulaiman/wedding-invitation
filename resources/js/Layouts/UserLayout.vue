...
const navigation = [
    ...
    { name: 'Profil Saya', href: 'user.profile.edit', icon: UserIcon },
]
    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <aside
            ...
            <nav class="space-y-1 px-3 py-4">
                <Link v-for="item in navigation" :key="item.href" :href="route(item.href)"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition" :class="route().current(item.href)
        ...
        <div class="lg:pl-64">
            <header
                class="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-5 lg:px-8">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div
                        class="flex h-9 w-9 items-center justify-center rounded-full bg-pink-100 text-sm font-semibold text-pink-700">
